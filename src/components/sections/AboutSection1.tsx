  ...
  return (
    <>
      ...
      <section id="hello" className="relative min-h-screen bg-surface-background flex items-center justify-center z-30">
        <h1 className="text-[7.5rem] md:text-[9rem] lg:text-[12rem] xl:text-[16rem] font-bold text-content-primary leading-none">
          Hello
        </h1>
      </section>
      ...
      <section id="intro" className="relative min-h-screen bg-surface-background flex items-center justify-center px-6 z-30">
        <p className="text-8xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold text-content-primary text-center max-w-4xl">
