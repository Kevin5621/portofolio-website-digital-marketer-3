  ...
  return (
    <>
      ...
      <section id="hello" className="relative min-h-screen bg-surface-background flex items-center justify-center z-30">
        <h1 className="text-6xl md:text-8xl lg:text-9xl xl:text-[12rem] font-bold text-content-primary leading-none" style={{fontSize: '8.5rem'}}>
          Hello
        </h1>
      </section>
      ...
      <section id="experience" className="relative min-h-screen bg-surface-background flex items-center justify-center px-6 z-30">
        <p className="text-lg md:text-xl lg:text-2xl text-content-secondary text-center max-w-4xl leading-relaxed" style={{fontSize: '3.5rem'}}>
