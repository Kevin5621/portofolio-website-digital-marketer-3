  ...
  return (
    <>
      ...
      <section id="creating-content" className="relative min-h-screen bg-surface-inverse flex items-center justify-center px-6 z-30">
        <h2 className="text-[6.5rem] md:text-[7.5rem] lg:text-[7.5rem] xl:text-[12rem] font-extrabold text-content-inverse leading-[0.85] tracking-[-0.02em] text-center max-w-8xl">
