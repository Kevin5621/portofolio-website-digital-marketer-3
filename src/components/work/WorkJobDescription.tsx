    ...
    <section className="bg-surface-background">
      <div className="max-w-[95vw] mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <p className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold text-content-primary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 mb-16">
          ...
          <div>
            <h2 className="text-4xl sm:text-5xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold text-content-primary leading-tight">
              Job Description
            </h2>
          </div>
            ...
            {workDetail.jobDescription.length > 1 ? (
              <ul className="space-y-4">
                {workDetail.jobDescription.map((job) => (
                  <li key={job} className="flex items-start gap-3 text-lg sm:text-xl md:text-xl lg:text-2xl xl:text-3xl font-medium text-content-primary leading-[0.95]">
              ...
              {workDetail.objectives.length > 1 ? (
                <ul className="space-y-4">
                  {workDetail.objectives.map((objective) => (
                    <li key={objective} className="flex items-start gap-3 text-lg sm:text-xl md:text-xl lg:text-2xl xl:text-3xl font-medium text-content-primary leading-[0.95]">
                      <span className="flex-shrink-0">•</span>
              ...
              {workDetail.challenges.length > 1 ? (
                <ul className="space-y-4">
                  {workDetail.challenges.map((challenge) => (
                    <li key={challenge} className="flex items-start gap-3 text-lg sm:text-xl md:text-xl lg:text-2xl xl:text-3xl font-medium text-content-primary leading-[0.95]">
                      <span className="flex-shrink-0">•</span>
            ...
            {workDetail.solutions.length > 1 ? (
              <ul className="space-y-4">
                {workDetail.solutions.map((solution) => (
                  <li key={solution} className="flex items-start gap-3 text-lg sm:text-xl md:text-xl lg:text-2xl xl:text-3xl font-medium text-content-primary leading-[0.95]">
                    <span className="flex-shrink-0">•</span>
