...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="min-h-screen bg-surface-background flex items-center justify-center">
      ...
      <section className="min-h-screen bg-surface-background flex items-center justify-center px-6">
      ...
      <section className="min-h-screen bg-surface-inverse flex items-center justify-center">
      ...
      <section className="min-h-screen bg-surface-inverse flex items-center justify-center px-6">
