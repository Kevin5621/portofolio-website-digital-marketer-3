...
const WorkTableRow = ({ item, onHover, onLeave }: { item: WorkItem, onHover?: () => void, onLeave?: () => void }) => {
  ...
  return (
    <div className="relative overflow-hidden group" ref={rowRef}>
      ...
      <button
        className="grid grid-cols-12 gap-4 md:gap-8 py-6 md:py-8 border-b border-border-secondary hover:bg-surface-secondary transition-colors duration-200 group cursor-pointer w-full text-left relative z-10"
        onClick={handleClick}
